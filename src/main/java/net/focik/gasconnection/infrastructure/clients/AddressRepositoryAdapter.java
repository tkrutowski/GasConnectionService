...
public class AddressRepositoryAdapter implements IAddressRepository {
    ...
    public Optional<AddressDto> findAddressById(Integer id) {
        ...
        try {
            ...
            log.info(addressDto != null ? "GASCONNECTION-SERVICE: Found address for id = " + id : "GASCONNECTION-SERVICE: Not found address for id = " + id);
        }catch (RestClientException ex){
            //TODO może rzucić wyjątek albo legger error
            log.error("AddressRepositoryAdapter findAddressById. Message: "+ex.getMessage());
